...
dict[string, struct[
    ...
    string,
    string,
    variant[int64, string, boolean],
    variant[int64, string, boolean],
    array[struct[enum[self.BoundType], variant[int64, string, boolean], string]]
]]
```
...
- **Current Value (variant[int64, string, boolean])**: The current value of the
  attribute.
- **Default Value (variant[int64, string, boolean])**: The default value of the
  attribute.
