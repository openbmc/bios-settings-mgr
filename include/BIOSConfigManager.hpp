...
class BIOSConfigMgr : sdbusplus::xyz::openbmc_project::BIOSConfig::server::Manager
{
  public:
    BIOSConfigMgr(boost::asio::io_service& io,
    ...
    std::tuple<AttributeType, std::variant<int64_t, std::string>, std::variant<int64_t, std::string>> getAttribute(
